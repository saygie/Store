        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxIdentificationNumber = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    TaxAdministration = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    CorporateName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, false, "Ankara" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, true, false, "Yenimahalle" },
                    { 2, 1, true, false, "Gölbaşı" }
                });

            migrationBuilder.InsertData(
                table: "Neighborhood",
                columns: new[] { "Id", "CountyId", "IsActive", "IsDeleted", "Name" },
                values: new object[,]
                {
                    { 1, 1, true, false, "Çamlıca Mahallesi" },
                    { 2, 2, true, false, "İncek Mahallesi" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Address",
                columns: new[] { "Id", "AddressDetail", "CorporateName", "FirstName", "IsActive", "IsCorporate", "IsDeleted", "LastName", "NeighborhoodId", "Phone", "TaxAdministration", "TaxIdentificationNumber", "Title", "UserId" },
                values: new object[,]
                {
                    { 1, "162 Cad. 14/B Kat:1 No:6", null, "Ersel", true, false, false, "Saygı", 1, "5539288584", null, null, "Ev", "66016ad3-baa8-4be9-bdf0-38a53ca57ec9" },
                    { 2, "30648 Cadde T2-0 Blok Belediye No:0/0", null, "Ersel", true, false, false, "Saygı", 2, "5539288584", null, null, "İş", "66016ad3-baa8-4be9-bdf0-38a53ca57ec9" }
                });
