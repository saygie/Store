...
$(document).ready(function(){
    ...
    $("*[maintheme]").click(function(e){
        ...
        $('#maintheme').attr({href: '../../plugins/wchat/assets/css/'+currentStyle+'.css'})
    });

    var currentTheme = localStorage.wchat_maintheme;
    if(currentTheme)
    {
        $('#maintheme').attr({href: '../../plugins/wchat/assets/css/'+currentTheme+'.css'});
    ...
    $("*[theme]").click(function(e){
        ...
        $('#theme').attr({href: '../../plugins/wchat/assets/css/colors/'+currentStyle+'.css'})
    });
    ...
    if(currentTheme)
    {
        $('#theme').attr({href: '../../plugins/wchat/assets/css/colors/'+currentTheme+'.css'});
