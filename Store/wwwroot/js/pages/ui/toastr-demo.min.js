! function(e) {
    ...
    e("#closeButton").on("click", function() {
        ...
        var t = e("#toastTypeGroup input:radio:checked").val(),
            n = e("#message").val(),
            l = e("#title").val() || "",
            s = e("#showDuration"),
            c = e("#hideDuration"),
        ...
        toastr.options = {
            ...
            onclick: null
        }, e("#addBehaviorOnToastClick").prop("checked") && (toastr.options.onclick = function() {
            alert("You can perform some custom action after a toast goes away")
        }), e("#addBehaviorOnToastCloseClick").prop("checked") && (toastr.options.onCloseClick = function() {
        ...
        var x = toastr[t](n, l);
        return a = x, "undefined" != typeof x ? (x.find("#okBtn").length && x.delegate("#okBtn", "click", function() {
            alert("you clicked me. i was toast #" + f + ". goodbye!"), x.remove()
        }), x.find("#surpriseBtn").length && x.delegate("#surpriseBtn", "click", function() {
            alert("Surprise! you clicked me. i was toast #" + f + ". You could perform an action here.")
        }), x.find(".clear").length && x.delegate(".clear", "click", function() {
            toastr.clear(x, {
                force: !0
            })
        }), !1) : void 0
